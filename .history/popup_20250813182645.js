document.addEventListener('DOMContentLoaded', async () => {
  ...
  chrome.storage.sync.get(['format','quality','filename','autoDownload','addTimestamp'], (data) => {
  ...
  [formatSel, qualityInput, filenameInput, autoDownload, addTimestamp].forEach(el => el.addEventListener('change', persistSettings));
